  ...
  methods: {
    ...
    async getAllGuru() {
      try {
        ...
        const response = await axios.get(this.api_url + '/user/survey/data-guru/' + checkRole, config)
    ...
    async startPkg(e) {
      ...
      if (!this.$refs.formStartPkg.validate()) {
        ...
        try {
          ...
          await axios.post(this.api_url + '/user/survey/create/other-than-admin', formData, config)
          ...
          this.$router.push(`/${checkRole}/pkg/create/${firstKomponenId}`)
