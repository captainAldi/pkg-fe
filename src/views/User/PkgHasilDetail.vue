  ...
  methods: {
    ...
    async getCurrentData() {
      try {
        ...
        const response = await axios.get(this.api_url + '/user/hasil-survey/' + this.idProfile, config)
    ...
    async exportPDF() {
      try {
        ...
        const response = await axios.get(`${this.api_url}/user/cetak/hasil-survey/${this.idProfile}`, config)
