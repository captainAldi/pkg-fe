        ...
        if (sw.value) {
          ...
          try {
            ...
            this.dataPkg.indikator.forEach(element => {
              formData.append('indikator[]', element)
            });

            formData.append('data_guru', this.dataPkg.data_guru)
            formData.append('nilaiKomp1', this.dataPkg.nilai_komp1)
            formData.append('nilaiKomp2', this.dataPkg.nilai_komp2)
            formData.append('nilaiKomp3', this.dataPkg.nilai_komp3)
            formData.append('nilaiKomp4', this.dataPkg.nilai_komp4)
            formData.append('nilaiKomp5', this.dataPkg.nilai_komp5)
            formData.append('nilaiKomp6', this.dataPkg.nilai_komp6)
            formData.append('nilaiKomp7', this.dataPkg.nilai_komp7)
            formData.append('nilaiKomp8', this.dataPkg.nilai_komp8)
            formData.append('nilaiKomp9', this.dataPkg.nilai_komp9)
            formData.append('nilaiKomp10', this.dataPkg.nilai_komp10)
            formData.append('nilaiKomp11', this.dataPkg.nilai_komp11)
            formData.append('nilaiKomp12', this.dataPkg.nilai_komp12)
            formData.append('nilaiKomp13', this.dataPkg.nilai_komp13)
            formData.append('nilaiKomp14', this.dataPkg.nilai_komp14)
            ...
            this.$router.push('/admin/hasil-pkg')
